...
def register_Ns3ShqQueueDisc_methods(root_module, cls):
    ## shq-queue-disc.h (module 'traffic-control'): static ns3::TypeId ns3::ShqQueueDisc::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## shq-queue-disc-queue-disc.h (module 'traffic-control'): ns3::ShqQueueDisc::ShqQueueDisc() [constructor]
    cls.add_constructor([])
    ## shq-queue-disc.h (module 'traffic-control'): ns3::Time ns3::ShqQueueDisc::GetQueueDelay() [member function]
    cls.add_method('GetQueueDelay', 
                   'ns3::Time', 
                   [])
    ## shq-queue-disc.h (module 'traffic-control'): ns3::ShqQueueDisc::FORCED_DROP [variable]
    cls.add_static_attribute('FORCED_DROP', 'char const * const', is_const=True)
    ## shq-queue-disc.h (module 'traffic-control'): ns3::ShqQueueDisc::UNFORCED_MARK [variable]
    cls.add_static_attribute('UNFORCED_MARK', 'char const * const', is_const=True)
    ## shq-queue-disc.h (module 'traffic-control'): ns3::ShqQueueDisc::UNFORCED_DROP [variable]
    cls.add_static_attribute('UNFORCED_DROP', 'char const * const', is_const=True)
    ## shq-queue-disc.h (module 'traffic-control'): void ns3::ShqQueueDisc::DoDispose() [member function]
    cls.add_method('DoDispose', 
                   'void', 
                   [], 
                   is_virtual=True, visibility='protected')
    ## shq-queue-disc.h (module 'traffic-control'): bool ns3::ShqQueueDisc::DoEnqueue(ns3::Ptr<ns3::QueueDiscItem> item) [member function]
    cls.add_method('DoEnqueue', 
                   'bool', 
                   [param('ns3::Ptr< ns3::QueueDiscItem >', 'item')], 
                   is_virtual=True, visibility='private')
    ## shq-queue-disc.h (module 'traffic-control'): ns3::Ptr<ns3::QueueDiscItem> ns3::ShqQueueDisc::DoDequeue() [member function]
    cls.add_method('DoDequeue', 
                   'ns3::Ptr< ns3::QueueDiscItem >', 
                   [], 
                   is_virtual=True, visibility='private')
    ## shq-queue-disc.h (module 'traffic-control'): bool ns3::ShqQueueDisc::CheckConfig() [member function]
    cls.add_method('CheckConfig', 
                   'bool', 
                   [], 
                   is_virtual=True, visibility='private')
    ## shq-queue-disc.h (module 'traffic-control'): void ns3::ShqQueueDisc::InitializeParams() [member function]
    cls.add_method('InitializeParams', 
                   'void', 
                   [], 
                   is_virtual=True, visibility='private')
